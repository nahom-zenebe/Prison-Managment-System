  ...
  return (
    <div className="sidebar">
      <div className="dashboard-header">
        ...
        />
        <div className="topic">Prison Management Ssystem</div>
      </div>
      ...
      >
        <Menu.Item className="mainMenu" key="/mainsecurity">
          Security Resources
        </Menu.Item>
        <Menu.Item className="mainMenu" key="/maintransport">
          Transportation Resources
        </Menu.Item>
        <Menu.Item className="mainMenu" key="/mainmedical">
          Medical Resources
        </Menu.Item>
      </Menu>
    </div>
