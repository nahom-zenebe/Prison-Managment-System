...
const AllSecurityStaff = () => {
  ...
  const getAllSecurityStaff = async () => {
    try {
      const res = await axios.get(
        "https://prison-managment-system-backend.onrender.com/api/securityStaff/"
      );
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(
        `https://prison-managment-system-backend.onrender.com/api/securityStaff/delete/${deletingStaffId}`
      );
