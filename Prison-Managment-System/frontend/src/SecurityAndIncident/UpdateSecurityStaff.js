...
const UpdateSecurityStaff = ({
  ...
  const fetchSecurityStaffDetails = async (id) => {
    try {
      const response = await axios.get(
        `https://prison-managment-system-backend.onrender.com/api/securityStaff/${id}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://prison-managment-system-backend.onrender.com/api/securityStaff/update/${securityStaffId}`,
        securityStaffData
      );
