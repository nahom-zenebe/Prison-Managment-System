...
const AllIncident = () => {
  ...
  const getAllIncidents = async () => {
    try {
      const res = await axios.get(
        "https://prison-managment-system-backend.onrender.com/api/incident/"
      );
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(
        `https://prison-managment-system-backend.onrender.com/api/incident/delete/${deletingIncidentId}`
      );
      getAllIncidents();
