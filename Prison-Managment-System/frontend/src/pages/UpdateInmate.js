...
const UpdateInmate = ({ selectedInmate, updateInmate, onUpdate }) => {
  ...
  useEffect(() => {
    ...
    const formattedSelectedInmate = {
      ...selectedInmate,
      birthday: selectedInmate.birthday
        ? selectedInmate.birthday.split("T")[0]
        : null,
      admissionDate: selectedInmate.admissionDate
        ? selectedInmate.admissionDate.split("T")[0]
        : null,
      releaseDate: selectedInmate.releaseDate
        ? selectedInmate.releaseDate.split("T")[0]
        : null,
    };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          >
            ...
            <option value="Acceptance or Retention of stolen Property">
              Acceptance or Retention of stolen Property
            </option>
            <option value="Cheating">Cheating</option>
            <option value="Criminal Breach of Trust">
              Criminal Breach of Trust
            </option>
            <option value="Criminal Misappropriation">
            ...
            <option value="Counterfeiting of currency">
              Counterfeiting of currency
            </option>
            <option value="Bribery">Bribery</option>
            <option value="Cruelty to animals">Cruelty to animals</option>
            <option value="Appearing in Public Places Drunk">
              Appearing in Public Places Drunk
            </option>
            <option value="Behaviour in a Disorderly Manner">
              Behaviour in a Disorderly Manner
            </option>
            <option value="Counterfeiting of currency">
              Counterfeiting of currency
            </option>
            <option value="Clearing of Crown Land">
              Clearing of Crown Land
            </option>
            <option value="Committing Affray">Committing Affray</option>
            <option value="Failure to report to Police">
              Failure to report to Police
            </option>
            <option value="Giving False evidence">
              {" "}
              Giving False evidence
            </option>
            <option value="Managing a Brothel">Managing a Brothel</option>
            <option value="Possessing Prohibited Knife">
              Possessing Prohibited Knife
            </option>
            <option value="Obstruction of Government Officers">
              Obstruction of Government Officers
            </option>
            ...
            <option value="Using Explosives to kill fish">
              Using Explosives to kill fish
            </option>
            <option value="Viewing of Blue Films">Viewing of Blue Films</option>
            <option value="Gemming illegally">Gemming illegally</option>
            <option value="Possessing Guns">
              Possessing Guns, Pistols etc. without License
            </option>
            <option value="Other Offences Against Public Tranquility State Law and Order">
              Other Offences Against Public Tranquility State Law and Order
            </option>
            <option value="Unlawful Betting and Gambling">
              Unlawful Betting and Gambling
            </option>
            <option value="Maintenance">Maintenance</option>
            <option value="Motor Offences">Motor Offences</option>
            <option value="Narcotic drugs Offences">
              Narcotic drugs Offences
            </option>
            <option value="Cruelty to Children">Cruelty to Children</option>
            <option value="Sexual Abuse of Children">
              Sexual Abuse of Children
            </option>
            <option value="Having Sexual Intercourse with Children">
              Having Sexual Intercourse with Children
            </option>
            <option value="Unnatural Offences">
              Unnatural Offences ( With Children Under 16 Years )
            </option>
            <option value="Rape of a Girl">
              Rape of a Girl ( Under 16 Years )
            </option>
        ...
        <div>
          ...
          />
          <label htmlFor="lifeImprisonment">
            If the inmate is sentenced to Life Imprisonment or Death Penalty
            check this checkbox.
          </label>
        </div>
