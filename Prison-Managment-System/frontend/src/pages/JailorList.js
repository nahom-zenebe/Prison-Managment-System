...
const JailorList = () => {
  ...
  const updateJailor = async (id, updatedJailorData) => {
    try {
      await axios.put(
        `https://prison-managment-system-backend.onrender.com/Jailors/${id}, updatedJailorData`
      );
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://prison-managment-system-backend.onrender.com/Jailors/${selectedJailor._id}`
      );
