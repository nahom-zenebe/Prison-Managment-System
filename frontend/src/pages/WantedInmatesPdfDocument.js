    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <Text style={styles.value}>:    {selectedInmate.escapedDate ? new Date(selectedInmate.realReleaseDate).toISOString().split('T')[0] : ''}</Text>
          ...
          <Text style={styles.value}>:    {selectedInmate.physicalDescription}</Text>

          <Text style={styles.label}>Last Clothing Description</Text>
          <Text style={styles.value}>:    {selectedInmate.clothingDescription}</Text>
        </View>
